...
- [Fan-out Roadmap](fanout-roadmap.md) — the cardinality fan-out model (one input → many results; `set_outputs` + `ExpandPolicy`).
- [Implementation Plan](implementation-plan.md) — historical: the original MVP build order, deliverables, and definition of done.
