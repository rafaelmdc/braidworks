"""UniprotWeaver — the concrete Braidworks weaver for UniProt protein identity (gene/protein query -> accession + taxid + annotation).
...
class UniprotWeaver(BackendDispatchWeaver):
