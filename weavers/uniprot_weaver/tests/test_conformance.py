"""Conformance tests for uniprot_weaver — the weaver must match its spec.
...
from uniprot_weaver import factory
...
class TestConformance(WeaverConformanceTests):
    ...
    def build_weaver(self):
        ...
        builder = (
            getattr(factory, "build_uniprot_weaver_fixture", None) or factory.build_uniprot_weaver
        )
        return builder()
