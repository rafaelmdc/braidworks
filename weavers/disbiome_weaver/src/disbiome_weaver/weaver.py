"""DisbiomeWeaver — the concrete Braidworks weaver for Disbiome microbe–disease associations (taxid -> diseases + direction).
...
class DisbiomeWeaver(BackendDispatchWeaver):
