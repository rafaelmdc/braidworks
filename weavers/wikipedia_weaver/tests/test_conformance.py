"""Conformance tests for wikipedia_weaver — the weaver must match its spec.
...
from wikipedia_weaver import factory
...
class TestConformance(WeaverConformanceTests):
    ...
    def build_weaver(self):
        ...
        builder = (
            getattr(factory, "build_wikipedia_weaver_fixture", None)
            or factory.build_wikipedia_weaver
        )
        return builder()
