"""Contract tests for quickgo_weaver — execute_batch order/length + cache-key rules.
...
from quickgo_weaver import factory, vocab
...
def _build_weaver():
    ...
    builder = getattr(factory, "build_quickgo_weaver_fixture", None) or factory.build_quickgo_weaver
    return builder()
