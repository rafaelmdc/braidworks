"""Conformance tests for quickgo_weaver — the weaver must match its spec.
...
from quickgo_weaver import factory
...
class TestConformance(WeaverConformanceTests):
    ...
    def build_weaver(self):
        ...
        builder = (
            getattr(factory, "build_quickgo_weaver_fixture", None) or factory.build_quickgo_weaver
        )
        return builder()
