"""AgoraWeaver — the concrete Braidworks weaver for AGORA2 metabolic reconstructions (NCBI taxid -> reconstruction + reaction repertoire).
...
class AgoraWeaver(BackendDispatchWeaver):
