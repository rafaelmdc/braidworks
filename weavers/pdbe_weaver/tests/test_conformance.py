"""Conformance tests for pdbe_weaver — the weaver must match its spec.
...
from pdbe_weaver import factory
...
class TestConformance(WeaverConformanceTests):
    ...
    def build_weaver(self):
        ...
        builder = getattr(factory, "build_pdbe_weaver_fixture", None) or factory.build_pdbe_weaver
        return builder()
