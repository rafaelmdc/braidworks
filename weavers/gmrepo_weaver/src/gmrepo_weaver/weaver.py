"""GmrepoWeaver — the concrete Braidworks weaver for GMrepo gut-metagenome abundances (taxid -> prevalence + median relative abundance, global and per-phenotype).
...
class GmrepoWeaver(BackendDispatchWeaver):
