"""Conformance tests for gmrepo_weaver — the weaver must match its spec.
...
from gmrepo_weaver import factory
...
class TestConformance(WeaverConformanceTests):
    ...
    def build_weaver(self):
        ...
        builder = (
            getattr(factory, "build_gmrepo_weaver_fixture", None) or factory.build_gmrepo_weaver
        )
        return builder()
