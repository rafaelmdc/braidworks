"""MondoWeaver — the concrete Braidworks weaver for MONDO disease ontology (MeSH/MedDRA disease id -> unified MONDO id + is-a ancestors).
...
class MondoWeaver(BackendDispatchWeaver):
