"""BacdiveWeaver — the concrete Braidworks weaver for BacDive type-strain phenotypes (scientific name -> microbe traits).
...
class BacdiveWeaver(BackendDispatchWeaver):
